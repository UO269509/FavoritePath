...
public class ListShareAdapter extends RecyclerView.Adapter<ListShareAdapter.AmigoViewHolder> {

    private List<Amigo> amigos;
    private final OnItemClickListener listener;

    public ListShareAdapter(List<Amigo> amigos, OnItemClickListener listener) {
        this.amigos = amigos;
    ...
    public AmigoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.linear_recycler_view_share, parent, false);
